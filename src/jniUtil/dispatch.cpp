 ...
 * Java_jniUtil_CFunction_callInt implementation exactly the same as what
 ...
 */
	...
	#define FIND_ENTRY(lib, name) GetProcAddress((HMODULE)lib, name)
#else
	#include <dlfcn.h>
...
#include "jniUtil_CPointer.h"
#include "jniUtil_CFunction.h"
#include "jniUtil_CMalloc.h"
...
Java_jniUtil_CFunction_initIDs(JNIEnv *env, jclass cls)
{
...
Java_jniUtil_CFunction_callCPointer(JNIEnv *env, jobject self, jobjectArray arr)
{
    jvalue result;
...
Java_jniUtil_CFunction_callDouble(JNIEnv *env, jobject self, jobjectArray arr)
{
    jvalue result;
...
Java_jniUtil_CFunction_callFloat(JNIEnv *env, jobject self, jobjectArray arr)
{
    jvalue result;
...
JNIEXPORT jint JNICALL Java_jniUtil_CFunction_callInt
...
Java_jniUtil_CFunction_callInt(JNIEnv *env, jobject self, jobjectArray arr)
{
    jvalue result;
 ...
 */
JNIEXPORT void JNICALL
Java_jniUtil_CFunction_callVoid(JNIEnv *env, jobject self, jobjectArray arr)
{
    jvalue result;
    dispatch(env, self, arr, TY_INTEGER, &result);
}
 ...
 */
JNIEXPORT jlong JNICALL Java_jniUtil_CFunction_find
 ...
 */
JNIEXPORT jint JNICALL 
Java_jniUtil_CPointer_initIDs(JNIEnv *env, jclass cls)
{
 ...
 * Signature: (I[BII)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyIn__I_3BII
 ...
 * Signature: (I[CII)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyIn__I_3CII
 ...
 * Signature: (I[DII)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyIn__I_3DII
 ...
 * Signature: (I[FII)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyIn__I_3FII
 ...
 * Signature: (I[III)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyIn__I_3III
 ...
 * Signature: (I[JII)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyIn__I_3JII
 ...
 * Signature: (I[SII)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyIn__I_3SII
 ...
 * Signature: (I[BII)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyOut__I_3BII
  (JNIEnv *env, jobject self, jint boff, jbyteArray arr, jint off, jint n)
{
    jbyte *peer = (jbyte *)env->GetLongField(self, FID_CPointer_peer);
 ...
 * Signature: (I[CII)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyOut__I_3CII
  (JNIEnv *env, jobject self, jint boff, jcharArray arr, jint off, jint n)
{
    jchar *peer = (jchar *)env->GetLongField(self, FID_CPointer_peer);
 ...
 * Signature: (I[DII)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyOut__I_3DII
  (JNIEnv *env, jobject self, jint boff, jdoubleArray arr, jint off, jint n)
{
    jdouble *peer = (jdouble *)
        env->GetLongField(self, FID_CPointer_peer);
 ...
 * Signature: (I[FII)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyOut__I_3FII
  (JNIEnv *env, jobject self, jint boff, jfloatArray arr, jint off, jint n)
{
    jfloat *peer = (jfloat *)
        env->GetLongField(self, FID_CPointer_peer);
 ...
 * Signature: (I[III)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyOut__I_3III
  (JNIEnv *env, jobject self, jint boff, jintArray arr, jint off, jint n)
{
    jint *peer = (jint *)env->GetLongField(self, FID_CPointer_peer);
 ...
 * Signature: (I[JII)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyOut__I_3JII
  (JNIEnv *env, jobject self, jint boff, jlongArray arr, jint off, jint n)
{
    jlong *peer = (jlong *)env->GetLongField(self, FID_CPointer_peer);
 ...
 * Signature: (I[SII)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_copyOut__I_3SII
  (JNIEnv *env, jobject self, jint boff, jshortArray arr, jint off, jint n)
{
    jshort *peer = (jshort *)
        env->GetLongField(self, FID_CPointer_peer);
 ...
 * Signature: (I)B
 */
JNIEXPORT jbyte JNICALL Java_jniUtil_CPointer_getByte
 ...
 */
JNIEXPORT jobject JNICALL Java_jniUtil_CPointer_getCPointer
  (JNIEnv *env, jobject self, jint index)
{
    void *ptr;
    jbyte *peer = (jbyte *)env->GetLongField(self, FID_CPointer_peer);
 ...
 * Signature: (I)D
 */
JNIEXPORT jdouble JNICALL Java_jniUtil_CPointer_getDouble
  (JNIEnv *env, jobject self, jint index)
{
    jdouble res;
    jbyte *peer = (jbyte *)env->GetLongField(self, FID_CPointer_peer);
 ...
 * Signature: (I)F
 */
JNIEXPORT jfloat JNICALL Java_jniUtil_CPointer_getFloat
  (JNIEnv *env, jobject self, jint index)
{
    jfloat res;
    jbyte *peer = (jbyte *)env->GetLongField(self, FID_CPointer_peer);
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_jniUtil_CPointer_getInt
  (JNIEnv *env, jobject self, jint index)
{
    jint res;
    jbyte *peer = (jbyte *)env->GetLongField(self, FID_CPointer_peer);
 ...
 * Signature: (I)J
 */
JNIEXPORT jlong JNICALL Java_jniUtil_CPointer_getLong
  (JNIEnv *env, jobject self, jint index)
{
    jlong res;
    jbyte *peer = (jbyte *)env->GetLongField(self, FID_CPointer_peer);
 ...
 * Signature: (I)S
 */
JNIEXPORT jshort JNICALL Java_jniUtil_CPointer_getShort
  (JNIEnv *env, jobject self, jint index)
{
    jshort res;
    jbyte *peer = (jbyte *)env->GetLongField(self, FID_CPointer_peer);
 ...
 */
JNIEXPORT jstring JNICALL Java_jniUtil_CPointer_getString
  (JNIEnv *env, jobject self, jint index)
{
    jbyte *peer = (jbyte *)env->GetLongField(self, FID_CPointer_peer);
 ...
 * Signature: (IB)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_setByte
 ...
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_setCPointer
 ...
 * Signature: (ID)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_setDouble
 ...
 * Signature: (IF)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_setFloat
 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_setInt
 ...
 * Signature: (IJ)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_setLong
 ...
 * Signature: (IS)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_setShort
 ...
 */
JNIEXPORT void JNICALL Java_jniUtil_CPointer_setString
 ...
 * Signature: (I)J
 */
JNIEXPORT jlong JNICALL Java_jniUtil_CMalloc_malloc
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_jniUtil_CMalloc_free
